...
public class main {
    public static void main(String[] args) {
         ...
         * there is very good concept of shadowing, when having same name of variables. a, this.a, outer.a, outer.outer.a;
         * //Note when same variable name, priority will be given to local first. than variable in scope, than variable if part of outer.
         *
         * **/
